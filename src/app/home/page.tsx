          ...
          <div className="hero-content grid grid-cols-1 lg:grid-cols-1 items-center">
            ...
            <div className="lg:flex-col lg:items-center">
              <h2 className="text-1xl lg:text-1xl text-center lg:text-center font-bold mb-5">
                Hi Welcome, I&apos;m{" "}
                <span className="text-blue-400">Enggi Pratama</span> 🙌
              </h2>
          ...
          <div className="flex flex-col w-full items-center mt-10 mb-10">
            <div className="rounded-box grid grid-cols-3 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 gap-2 mb-5">
              ...
              <figure>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-4 w-4 mt-1 self-center"
                  viewBox="0 0 384 512"
                >
                  <path
                    fill="#ffffff"
            ...
            <div className="lg:flex-col lg:items-center">
              <h2 className="text-1xl lg:text-1xl text-center lg:text-center font-bold mb-5">
                I Learn Through{" "}
                <span className="text-blue-400">Experiences</span> 😎❤️
              </h2>
              <p className="text-justify lg:text-justify">
                I&apos;m Enggi Pratama, from Indonesia. I&apos;ve spent my time
                to take any opportunity as well as developing my experience and
                skills to things like Graphic Designing, Programming, and many
                others. <br /> <br />
                But one thing I always stick with everything is, I always do
                every works as my passion, and that&apos;s what makes me happy
                also giving myself a chance to deliver best works that i can do.
              </p>
            </div>
          </div>
        </div>
