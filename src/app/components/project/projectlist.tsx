...
const ProjectList = () => {
  return (
    <div className="flex flex-col w-full mt-5 px-20 mb-10">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        <div className="card bg-base-200 shadow-xl">
          ...
          <div className="card bg-base-200 shadow-xl mt-5">
            <h2 className="text-center lg:text-center">
              Website Gudang & Penjualan
            </h2>
            <div className="flex flex-col w-full items-center">
              <ul className="menu bg-base-200 rounded-box grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-1">
                <li>
                  <a
                    className="tooltip"
                    data-tip="Github"
        ...
        <div className="card bg-base-200 shadow-xl px-10">
          ...
          <div className="items-center max-w-full">
            <h2 className="text-center lg:text-center">Comming Soon</h2>
            <div className="flex flex-col w-full items-center">
              <ul className="menu bg-base-200 rounded-box grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-1">
                <li>
                  <a
